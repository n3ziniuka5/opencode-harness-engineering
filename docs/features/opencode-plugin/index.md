...
This directory records durable behavior for the current OpenCode plugin bundle.
...
| [`plan-agent.md`](plan-agent.md) | Behavior and constraints for the `plan` bundled agent. | You are changing the planning prompt, permissions, model, sampling, or archive behavior. |
