...
- Draft-specific success criteria require proposed code changes to conform to discovered engineering guidance and require the Verification plan to conform to discovered testing strategy and validation requirements.
