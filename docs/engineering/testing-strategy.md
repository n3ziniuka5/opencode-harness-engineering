...
- `test/plugin.test.ts` verifies the plugin id, server export, absence of bundled tools, `explore` registration, sampling, and permission sentinels, `plan` registration and sampling sentinels, and direct overriding of existing agent entries.
