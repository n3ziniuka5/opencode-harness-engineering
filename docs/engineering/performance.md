...
This package does not serve requests or maintain a long-running process of its own. Performance concerns are plugin initialization cost, prompt/config size, test speed, and TypeScript build time.
