...
- For planning prompts, require traceable implementation plans with requirements, named files or systems, external contracts, data flow, validation, failure behavior, security considerations, and open questions.
