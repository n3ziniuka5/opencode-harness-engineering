...
- Use `reasoning` effort intentionally. This bundle uses GPT-5.5 `high` only for the `plan` agent because its job is complex planning with codebase discovery and contract analysis.
